                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group row">
                                                <div class="col-md-12">
                                                    <label for="image">{{ __('Thumbnail Image') }} <span class="text-danger">*</span></label><br>
                                                    <div>
                                                        <img src="{{ storage_url($news->img) }}" alt="{{ $news->title }}"
                                                            class="display-image">
                                                    </div>
                                                    <input type="file" name="image" id="image" class="image-upload" data-file="{{ $news->img ? storage_url($news->img) : null }}">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group row">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" name="title" id="title" class="form-control" value="{{$news->title }}" placeholder="Enter news title">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select name="category[]" id="category" class="form-control select" multiple>
                                                        @foreach ($categories as $category)
                                                            <option value="{{ $category->id }}">{{ $category->title }}({{ $category->activeSubCategories->count() }})</option>
                                                        @endforeach
                                                    </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="input-group align-items-center">
                                                <input type="radio" class="btn-check" name="main" id="main-yes" autocomplete="off"  value="1" {{$news->is_main = 1 ? 'checked' : ''}}>
                                                <label class="btn btn-outline-success w-50" for="main-yes">Yes</label>

                                                <input type="radio" class="btn-check" name="main" id="main-no" autocomplete="off" value="0" {{$news->is_main = 0 ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="input-group align-items-center">
                                                <input type="radio" class="btn-check" name="featured" id="featured-yes" autocomplete="off" value="1" {{$news->is_featured = 1 ? 'checked' : ''}}>
                                                <label class="btn btn-outline-success w-50" for="featured-yes">Yes</label>

                                                <input type="radio" class="btn-check" name="featured" id="featured-no" autocomplete="off" value="0" {{$news->is_featured = 0 ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="input-group align-items-center">
                                                <input type="radio" class="btn-check" name="trending" id="trending-yes" autocomplete="off"  value="1" {{$news->is_trending = 1 ? 'checked' : ''}}>
                                                <label class="btn btn-outline-success w-50" for="trending-yes">Yes</label>

                                                <input type="radio" class="btn-check" name="trending" id="trending-no" autocomplete="off" value="0" {{$news->is_trending = 0 ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="input-group align-items-center">
                                                <input type="radio" class="btn-check" name="status" id="status-yes" autocomplete="off" value="1" {{$news->status = 1 ? 'checked' : ''}}>
                                                <label class="btn btn-outline-success w-50" for="status-yes">Active</label>

                                                <input type="radio" class="btn-check" name="status" id="status-no" autocomplete="off" value="0" {{$news->status = 1 ? 'checked' : ''}}>
